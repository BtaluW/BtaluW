...
function Avatar({
  ...
  return (
    <Link
      ...
      {...props}
    >
      {/* TODO: swap for a real photo — replace this div with an Image
          pointed at @/images/avatar.jpg once one exists */}
      <div
        className={clsx(
          'flex items-center justify-center rounded-full bg-teal-500 font-semibold text-white dark:bg-teal-400 dark:text-zinc-900',
          large ? 'h-16 w-16 text-xl' : 'h-9 w-9 text-sm',
        )}
      >
        BT
      </div>
